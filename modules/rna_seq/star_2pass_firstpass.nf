...
process 'star_2pass_1st_pass' {
    ...
    publishDir "${params.outdir}/star_pass2_1stpass/$samplename", mode: 'rellink', pattern: "*.out"
    publishDir "${params.outdir}/star_pass2_1stpass/$samplename", mode: 'rellink', pattern: "*.tab"
